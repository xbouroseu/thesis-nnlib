...
//         batch_start = 0;
        ...
        cout << "Step duration: " << std::setprecision(15) << std::fixed << (clock()-step_start)/CLOCKS_PER_SEC << endl;
    }
    
    duration = clock() - start;
    
    cout << "Train Duration: " << std::setprecision(15) << std::fixed << duration/CLOCKS_PER_SEC << endl;
    }
